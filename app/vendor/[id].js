...
import { View, Text, ScrollView, TouchableOpacity, StyleSheet, Image, Dimensions, TextInput } from 'react-native';
    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      <ScrollView>
          ...
          <View style={styles.headerOverlay} pointerEvents="box-none">
            <View style={styles.topRow}>
              ...
              <View style={styles.searchBox}>
                ...
                <TextInput placeholder="search" style={styles.searchInput} placeholderTextColor="#A0A0A0" />
            </View>
              <TouchableOpacity style={styles.circleBtn} onPress={() => { /* share action */ }}>
        ...
        <View style={styles.headerInfo}>
          ...
          <Text style={styles.status}>★ {vendor.rating} • {vendor.status} • Opens at {vendor.openingTime}</Text>
        </View>
      ...
      {(selectedItem || orders.length > 0) && (
        <TouchableOpacity style={styles.checkOrderBtn}>
          <Text style={styles.checkOrderText}>{selectedItem ? `₦${selectedItem.price}` : `₦${orders.reduce((s,i)=>s+(i.price||0),0)}`}</Text>
        </TouchableOpacity>
      )}
